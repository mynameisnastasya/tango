...
export default function Privacy(){
  return <main className="legal-page">
    <Link href="/">← ABHIGREEN</Link>
    <h1>Privacy Policy</h1>
    <p className="legal-updated">Last updated: September 23, 2026</p>
    <section><h2>Information we collect</h2><p>When you submit an application, ABHIGREEN may collect the contact and profile information you choose to provide, including your name, country, languages, social-media usernames, messaging contacts, live-streaming platform information, referral code, availability and introduction.</p></section>
    ...
    <section><h2>Sharing and retention</h2><p>Application information may be accessible to authorized ABHIGREEN managers and service providers used to operate the website and applicant database. Information should be retained only as long as reasonably needed for recruitment, agency operations, legal obligations, and dispute resolution.</p></section>
    <section><h2>Your choices</h2><p>You may contact ABHIGREEN through the contact methods shown on the website to request correction or deletion of application data, subject to applicable legal requirements.</p></section>
